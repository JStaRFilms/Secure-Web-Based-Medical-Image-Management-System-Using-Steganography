        ...
        <div className="min-h-screen flex items-center justify-center bg-slate-50 dark:bg-zinc-950 px-4">
            <div className="max-w-md w-full bg-white dark:bg-zinc-900 border border-slate-200 dark:border-zinc-800 rounded-2xl p-8 shadow-xl">
                <div className="text-center mb-8">
                    ...
                    <h1 className="text-2xl font-bold tracking-tight">Register Access</h1>
                    <p className="text-slate-500 dark:text-zinc-400 text-sm mt-2">Create a new secure account.</p>
                </div>

                <div className="space-y-4">
                    <div>
                        <label className="block text-sm font-medium mb-1 text-slate-700 dark:text-zinc-300">Full Name</label>
                        <input
                            type="text"
                            value={name}
                ...
                <div className="mt-6 text-center text-sm text-slate-500 dark:text-zinc-400">
                    Already registered? <Link href="/sign-in" className="text-blue-600 dark:text-cyan-400 hover:underline">Sign in</Link>
                </div>
            </div>
        </div>
    )
